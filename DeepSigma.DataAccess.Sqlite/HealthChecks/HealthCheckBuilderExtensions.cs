using DeepSigma.DataAccess.Sqlite.HealthChecks;
...
/// <summary>
/// Health-check registration helpers for SQLite.
/// </summary>
public static class DeepSigmaSqliteHealthCheckExtensions
{
    /// <summary>
    /// Registers a SQLite health check that opens a connection and runs <c>SELECT 1</c>.
    /// </summary>
    /// <param name="builder">The <see cref="IHealthChecksBuilder"/>.</param>
    /// <param name="connectionString">SQLite connection string.</param>
    /// <param name="name">The registration name. Defaults to <c>"deepsigma_sqlite"</c>.</param>
    ...
    public static IHealthChecksBuilder AddDeepSigmaSqlite(
        this IHealthChecksBuilder builder,
        string connectionString,
        string name = "deepsigma_sqlite",
