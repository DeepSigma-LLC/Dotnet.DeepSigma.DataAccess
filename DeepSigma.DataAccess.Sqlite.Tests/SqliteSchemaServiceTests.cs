...
public class SqliteSchemaServiceTests : IClassFixture<SqliteSharedMemoryFixture>
{
    ...
    {
        IEnumerable<TableName> tables = await _schema.GetTables();
    ...
    {
        IEnumerable<TableField> fields = await _schema.GetTableFields();
    ...
    {
        IEnumerable<TableConstraint> constraints = await _schema.GetConstraints();
    ...
    {
        IEnumerable<TableForeignKey> fks = await _schema.GetForeignKeys();
